...
inline const char *EnumNameType(Type e) {
  if (::flatbuffers::IsOutRange(e, Type_NONE, Type_RunEndEncoded)) return "";
  const size_t index = static_cast<size_t>(e);
...
inline ::flatbuffers::Offset<DictionaryEncoding> CreateDictionaryEncoding(
    ...
    DictionaryKind dictionaryKind = DictionaryKind_DenseArray) {
...
struct Field FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  ...
  const RunEndEncoded *type_as_RunEndEncoded() const {
    return type_type() == Type_RunEndEncoded ? static_cast<const RunEndEncoded *>(type()) : nullptr;
  }
...
inline const Schema *GetSchema(const void *buf) {
  return ::flatbuffers::GetRoot<Schema>(buf);
}

inline const Schema *GetSizePrefixedSchema(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<Schema>(buf);
}

inline bool VerifySchemaBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<Schema>(nullptr);
}

inline bool VerifySizePrefixedSchemaBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<Schema>(nullptr);
}

inline void FinishSchemaBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<Schema> root) {
  fbb.Finish(root);
}
