...
#ifndef FLATBUFFERS_GENERATED_FILE_H_
#define FLATBUFFERS_GENERATED_FILE_H_
...
inline const Footer *GetFooter(const void *buf) {
  return ::flatbuffers::GetRoot<Footer>(buf);
}

inline const Footer *GetSizePrefixedFooter(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<Footer>(buf);
}

inline bool VerifyFooterBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<Footer>(nullptr);
}

inline bool VerifySizePrefixedFooterBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<Footer>(nullptr);
}

inline void FinishFooterBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<Footer> root) {
  fbb.Finish(root);
}
...
#endif  // FLATBUFFERS_GENERATED_FILE_H_
